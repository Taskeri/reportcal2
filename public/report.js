// ✅ report.js – כולל הפרדה בין תאריך/שעה ושמירה של מוצר, מידה, צבע בנפרד
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  reportForm.addEventListener("submit", async (e) => {
    ...
    const now = new Date();
    const reportDate = now.toLocaleDateString("he-IL");
    const reportTime = now.toLocaleTimeString("he-IL");
